...
- **성과**:
  ...
  - 보안 점검을 자동화해 CCE 미준수 항목의 반복 대응 부담을 줄임
...
- **주요 업무**:
  - 대체거래소 인프라 보안 아키텍처 설계 (대규모 서버 환경)
...
- **성과**:
  - AWS 보안 그룹 정책을 재검토해 불필요한 노출 정책을 정비
...
- **성과**:
  - Ansible 자동화로 VPN 보안 설정 배포를 자동화
  - 대규모 사용자 인증서 관리 자동화
