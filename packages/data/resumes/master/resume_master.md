...
- 금융권 매매체결시스템 정보보안팀 운영SM(System Maintenance)
- 정보보안 장비 운영 및 임직원 환경의 보안 관제

주요 업무

- SOC 교대 근무에서 보안 이벤트를 관제하고 등급별 대응 절차를 실행
...
2024.03 ~ 2025.02 | Nextrade 매매체결시스템 구축 프로젝트
...
### Nextrade 매매체결시스템 인프라 구축 및 운영

가온누리정보시스템 + 아이티센 CTS | 2024.03 ~ 2026.02

**프로젝트 개요**

- **프로젝트 성격**: 금융권 매매체결시스템 (다자간매매체결)
...
- **주요 업무**:
  - SOC 교대 근무에서 보안 이벤트를 관제하고 인시던트 대응 절차를 실행
