...
**파일 경로**: `packages/data/resumes/archive/toss/lee_jaecheol_toss_commerce_server_final.pdf`
**파일 크기**: 80KB
...
### 마크다운 원본
**파일 경로**: `packages/data/resumes/archive/toss/TOSS_COMMERCE_SERVER_FINAL.md`
**파일 경로 (No Emoji)**: `packages/data/resumes/archive/toss/TOSS_COMMERCE_SERVER_FINAL_NO_EMOJI.md`
...
**저장소**: http://gitlab.jclee.me/jclee/resume
...
**Tech Stack**: Markdown, GitHub Pages, GitLab CI/CD
**Status**: 🟢 Production
**특징**: 이력서 자동 현행화 시스템
