...
대규모 방화벽 룰 중 상당수가 사용하지 않는 룰이었습니다. 로그 분석을 통해 불필요한 룰을 제거하여 성능을 향상시키고 관리 복잡도를
줄였습니다.
