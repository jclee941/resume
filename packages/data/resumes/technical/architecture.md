...
capabilities, deployed on Cloudflare Workers edge network.
...
│  │  • apps/portfolio/index.html (portfolio)                │  │
│  │  • apps/portfolio/resume.html (apps/portfolio resume)              │  │
...
HTML files are embedded as JavaScript template literals in `worker.js` for
serverless deployment.

### 3. Static Site Generation

HTML is generated at build time, then served from edge locations for maximum
performance.
...
├── apps/portfolio/                 # Production site
...
3. **Web Generation**: Update `apps/portfolio/index.html` manually
4. **Build**: Run `node apps/portfolio/generate-worker.js`
