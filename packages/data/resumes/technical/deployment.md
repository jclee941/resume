...
# Update apps/portfolio portfolio
vim apps/portfolio/index.html
vim apps/portfolio/resume.html
```
...
- [ ] Update `apps/portfolio/index.html` if needed
- [ ] **Run `node apps/portfolio/generate-worker.js`** ⚠️
