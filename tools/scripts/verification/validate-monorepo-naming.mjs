...
const EXCLUDED_DIRS = new Set([
  'node_modules', '.git', 'dist', 'coverage', '.wrangler', '.next',
  'data', 'log', 'logs', 'tmp', 'profiles', '.sisyphus', '.cache',
  '.venv', '.ruff_cache', 'thoughts', 'infrastructure/n8n',
]);

// Allowed shell script exceptions (≤5 line stubs in .githooks/)
const ALLOWED_SH_PATTERNS = [
  /^\.githooks\//,
];
