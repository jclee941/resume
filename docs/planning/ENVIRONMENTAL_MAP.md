...
environments:
  ...
  development:
    ...
    command: 'cd apps/portfolio && python3 -m http.server 8000'
```
...
external_services:
  cloudflare_workers:
    ...
    config_file: 'apps/portfolio/wrangler.toml'
    worker_file: 'apps/portfolio/worker.js'
...
critical_paths:
  web_portfolio:
    - 'apps/portfolio/index.html' # Main portfolio page
    - 'apps/portfolio/resume.html' # Resume HTML version
    - 'apps/portfolio/worker.js' # Generated worker code (deployed)
    - 'apps/portfolio/generate-worker.js' # Worker generator script
    - 'apps/portfolio/wrangler.toml' # Cloudflare Workers config
...
generated_files:
  - 'apps/portfolio/worker.js' # Generated by generate-worker.js
...
deployment_flow:
  ...
  steps:
    ...
    2_deploy_worker:
      ...
      working_directory: 'apps/portfolio/'
...
local_development:
  ...
  worker_generation:
    ...
    output: 'apps/portfolio/worker.js'
