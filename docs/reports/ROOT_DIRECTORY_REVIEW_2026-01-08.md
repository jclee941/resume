...
- `apps/portfolio/`: Portfolio frontend (Cloudflare Worker)
- `apps/job-server/`: Backend automation (Node.js)
- `cmd/`: Ops tooling (Go)
...
| --------------------- | ------------------ | ---------- | ------------ |
| `apps/portfolio/`                | Portfolio Frontend | ✅ Clean   | None         |
| `apps/job-server/` | Automation Server  | ✅ Clean   | None         |
