...
describe('Logger Module', () => {
  ...
  describe('in test environment', () => {
    beforeEach(() => {
      ...
      logger = require('../../../../apps/portfolio/logger');
    });
  ...
  describe('in production environment', () => {
    ...
    test('debug should output with DEBUG env set', () => {
      ...
      jest.resetModules();
      const debugLogger = require('../../../../apps/portfolio/logger');
  ...
  describe('verbose mode', () => {
    ...
    test('verbose should be suppressed in test environment', () => {
      process.env.NODE_ENV = 'test';
      jest.resetModules();
      const testLogger = require('../../../../apps/portfolio/logger');
  ...
  describe('trace mode', () => {
    ...
    test('trace should be suppressed without DEBUG', () => {
      delete process.env.DEBUG;
      jest.resetModules();
      const noDebugLogger = require('../../../../apps/portfolio/logger');
    ...
    test('trace should be suppressed without VERBOSE', () => {
      ...
      jest.resetModules();
      const noVerboseLogger = require('../../../../apps/portfolio/logger');
