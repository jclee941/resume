...
function buildWorkerCode(options) {
  const preambleOpts = {
    ...
    resumeDataJson: options.resumeDataJson || '{}',
    resumeDataEnJson: options.resumeDataEnJson || options.resumeDataJson || '{}',
    resumeDataJaJson: options.resumeDataJaJson || options.resumeDataJson || '{}',
