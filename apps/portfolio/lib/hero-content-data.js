const HERO_CONTENT = {
  ko: {
    ...
    reviewLinks: [
      ...
      ['#projects', '자동화 방식', '탐지·알림·API 조회'],
      ['#contact', '채용 자료', 'PDF·메일 연결'],
    ],
    packetLabel: '채용 검토 자료',
    packetEyebrow: '채용 검토 자료',
    packetStatus: '검토 준비됨',
    packetSummary: '구축, 운영, 자동화 근거를 같은 순서로 확인할 수 있게 묶었습니다.',
    packetItems: [
    ...
    quickRoles: [
      ...
      ['automation', 'Automation', 'Slack/SMS 알림, 장비 API 조회'],
    ],
    actionsLabel: '주요 이동',
  ...
  en: {
    ...
    reviewLinks: [
      ...
      ['#projects', 'Automation approach', 'Detection · alerting · API lookup'],
    ...
    packetSummary: 'Build, operations, and automation evidence are grouped into one review flow.',
    packetItems: [
    ...
    quickRoles: [
      ...
      ['devsecops', 'DevSecOps / IaC', 'Terraform, Ansible, Cloudflare Workers'],
      ['automation', 'Automation', 'Slack/SMS alerts, appliance API lookup'],
    ],
  ...
  ja: {
    ...
    reviewLinks: [
      ...
      ['#projects', '自動化アプローチ', '検知・通知・API照会'],
      ['#contact', '採用資料', 'PDF・メール連携'],
    ],
    packetLabel: '採用検討資料',
    packetEyebrow: '採用検討資料',
    packetStatus: '確認準備済み',
    packetSummary: '構築、運用、自動化の根拠を同じ順序で確認できるよう整理しています。',
    packetItems: [
    ...
    quickRoles: [
      ...
      ['devsecops', 'DevSecOps / IaC', 'Terraform、Ansible、Cloudflare Workers'],
      ['automation', 'Automation', 'Slack/SMS通知、機器API照会'],
    ],
    actionsLabel: '主要導線',
