...
async function runWorkerBuild({ baseDir, version, gitSha = 'unknown', allowedEmails, logger }) {
  ...
  let indexHtml = await buildLocalizedHtml(indexHtmlRaw, {
    ...
    projectSchemasHtml: templates.projectSchemasHtml,
    ...
    profileBentoHtml: templates.profileBentoHtml,
    achievementsHtml: templates.achievementsHtml,
    expertiseHtml: templates.expertiseHtml,
    coverLetterHtml: templates.coverLetterHtml,
  ...
  let indexEnHtml = await buildLocalizedHtml(indexEnHtmlRaw, {
    ...
    projectSchemasHtml: templates.projectSchemasEnHtml,
  ...
  let indexJaHtml = await buildLocalizedHtml(buildJapaneseTemplate(indexHtmlRaw), {
    ...
    projectSchemasHtml: templates.projectSchemasJaHtml,
    ...
    achievementsHtml: templates.achievementsJaHtml,
    expertiseHtml: templates.expertiseJaHtml,
    coverLetterHtml: templates.coverLetterJaHtml,
    buildVersion: version,
    buildDeployedAt,
    buildDeployedDate,
