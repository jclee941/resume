function applyJapaneseSections(html) {
  return html
    ...
    .replace(/aria-label="2페이지 이력서 PDF 다운로드"/g, 'aria-label="2ページ履歴書PDFダウンロード"')
    .replace(/aria-label="상세 경력 PDF 다운로드"/g, 'aria-label="詳細職務経歴PDFダウンロード"')
    .replace(/>2페이지 이력서 PDF</g, '>2ページ履歴書PDF<')
    .replace(/>상세 경력 PDF</g, '>詳細職務経歴PDF<')
