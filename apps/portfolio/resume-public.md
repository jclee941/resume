...
- **무중단 프로덕션 배포**: CI/CD 파이프라인 구축 및 운영, 무중단 배포, 자동 롤백 시스템을 통한 서비스 배포 안정성을 위한 자동 롤백 체계 구성
...
- **규제 대응**: 금융감독원 정기 감사 대응, 지적사항 없이 통과
- **운영 최적화**: 보안 정책 재설계로 탐지 기준 정비
...
- **방화벽 자동화**: Python으로 방화벽 정책 배포 절차 자동화
- **에이전트 최적화**: EPP/CPP-DLP 충돌 원인 분석 및 정책 조정
- **보안 사고 예방**: 망분리 구축으로 내부정보 유출사고 없이 운영
- **규제 준수**: 금융규제 요건 충족, 본인가 심사 보안 측면 이슈 없이 대응
...
- **자동화 효과**: Python 스크립트로 반복 작업 자동화 및 운영 절차 표준화
- **컴플라이언스**: 금융감독원 정기 감사 통과, 개인정보 유출사고 없이 운영
- **구성 정비**: DB 접근제어 쿼리 튜닝 수행
- **POC 성공**: PB 플랫폼 구축 프로젝트 성능 검증 완료
...
- **안정성 강화**: 네트워크 세분화 및 모니터링 강화로 네트워크 세분화 및 모니터링 체계 구성
- **보안 강화**: APT·NAC·DLP 통합으로 APT·NAC·DLP 통합 정책 구성
- **정책 최적화**: DLP 룰 재설계로 민감정보 탐지 기준 정비
- **고가용성**: 이중화 아키텍처로 이중화 아키텍처 구성 및 장애 대응 절차 운영
...
- **자동화 구현**: Python으로 Cisco 스위치 점검 자동화, Cisco 스위치 점검 자동화
- **안정성 강화**: 백신-VPN 충돌 근본 원인 분석 및 해결로 백신-VPN 충돌 원인 분석 및 대응
- **정책 자동화**: Ansible로 NAC 예외정책 자동 배포, NAC 예외정책 자동 배포
...
- 성과: 금융위원회 본인가 심사 통과, 방화벽 자동화로 방화벽 정책 반영 절차 자동화

**운영 단계 (2025.03 ~ 2026.02)**

- 역할: 정보보안팀 운영 엔지니어
- 업무: 보안 솔루션 통합 운영, 교대 모니터링, 금융감독 대응
- 성과: 장애 대응 절차 정비, 이벤트 대응 흐름 표준화, 감사 지적사항 없이 통과
...
성과: 실시간 이상징후 탐지 시스템 구축, 인프라 리소스 운영 방식 정비
...
- 장애 대응 절차와 복구 자동화 경험을 통한 신속한 위기 대응 능력
- 예방적 보안 체계 구축 및 선제적 대응을 통한 침해 사고 발생률 최소화

### 자동화 주도 혁신 및 효율성 추구

- Python/Shell 스크립팅을 활용한 반복 업무 자동화 및 운영 프로세스 자동화 및 표준화
- 자동화를 통한 반복 운영 절차 자동화 및 리소스 운영 방식 정비
- Infrastructure as Code(IaC) 기반의 인프라 표준화 및 관리 절차 표준화

### 강력한 규제 준수 및 컴플라이언스 역량

- 금융감독원, 금융보안원 등 엄격한 국내외 정보보호 규제 및 감사 대응 경험
- 금융권 보안 규제 대응 및 정보호 인증 관리 경험
- 컴플라이언스 문서화 및 내부 감사 대응을 통한 조직의 컴플라이언스 문서화 및 내부 감사 대응 경험
