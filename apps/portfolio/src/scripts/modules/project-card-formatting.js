...
const ICON_PATHS = {
  antenna: '<path d="M12 18v4"/><path d="M8.5 14.5a5 5 0 0 1 7 0"/><path d="M5 11a10 10 0 0 1 14 0"/><circle cx="12" cy="12" r="1.5"/>',
  automation: '<path d="M12 3v3"/><path d="M12 18v3"/><path d="M3 12h3"/><path d="M18 12h3"/><circle cx="12" cy="12" r="4"/><path d="m15 9 3-3"/><path d="m6 18 3-3"/>',
  ...
  graduation: '<path d="m3 8 9-4 9 4-9 4z"/><path d="M7 10v5c0 1.7 2.2 3 5 3s5-1.3 5-3v-5"/><path d="M21 8v6"/>',
  grid: '<path d="M4 4h6v6H4z"/><path d="M14 4h6v6h-6z"/><path d="M4 14h6v6H4z"/><path d="M14 14h6v6h-6z"/>',
  layers: '<path d="m12 3 9 5-9 5-9-5z"/><path d="m3 12 9 5 9-5"/><path d="m3 16 9 5 9-5"/>',
  network: '<circle cx="6" cy="6" r="2"/><circle cx="18" cy="6" r="2"/><circle cx="12" cy="18" r="2"/><path d="m8 7 8 0"/><path d="m7 8 4 8"/><path d="m17 8-4 8"/>',
  rocket: '<path d="M5 19c2-5 6-10 14-14 0 8-9 12-14 14z"/><path d="M14 6h4v4"/><path d="M5 19l-2 2"/><path d="m8 16 2 2"/>',
  route: '<circle cx="6" cy="5" r="2"/><circle cx="18" cy="19" r="2"/><path d="M8 5h5a3 3 0 0 1 0 6H9a3 3 0 0 0 0 6h7"/>',
  search: '<circle cx="10.5" cy="10.5" r="6.5"/><path d="m16 16 4 4"/>',
  server: '<path d="M4 5h16v6H4z"/><path d="M4 13h16v6H4z"/><path d="M8 8h.01"/><path d="M8 16h.01"/>',
