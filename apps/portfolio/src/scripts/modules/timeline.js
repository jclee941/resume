...
function getCareerData() {
  ...
  return [
    ...
    },
    {
      ...
      description: '넥스트레이드 매매체결시스템의 금융위 본인가 심사 기준을 충족하는 고가용성 보안 인프라를 설계·구축했습니다. FortiGate FGCP 액티브-패시브 HA를 구성하고, 금융권 규제에 맞는 5계층 망분리 보안 아키텍처를 설계·문서화하여 FSC 본인가 사전 심사를 통과시켰습니다.',
      achievements: [
        '5계층 망분리 보안 아키텍처 설계',
        'FSC 본인가 사전 심사 통과',
      ],
